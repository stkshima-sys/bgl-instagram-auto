 ...
 * 2) AIで分析レポート＋改善案10個＋来週のジャンル比率提案を生成 → reports/ に保存
...
export async function weeklyAnalysis(): Promise<void> {
  ...
  const report = await chatText(
    `あなたはInstagramグロースの専門家です。18〜30歳の野球好き女性向けライフスタイルメディア
「Baseball Girls LIFE」（最終目的: プロフィールリンクから野球観戦マッチングサービスDraftへの女性会員送客）
の週次分析を行います。日本語のMarkdownで出力してください。`,
...
11. 来週の投稿ジャンル比率の提案（現行: グルメ30/コーデ20/一人観戦15/初心者15/球場紹介10/推し活10）
12. 来週の戦略と投稿テーマ案（曜日別にフィード14本＋リール7本）`,
  );
